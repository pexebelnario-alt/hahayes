jQuery(document).ready(function (p) {
  ...
  jQuery(".ult-responsive").each(function (e, a) {
    let t = jQuery(this),
      ...
      o = "";
    (void 0 === i && null == i) ||
      p.each(JSON.parse(i), function (e, a) {
        const i = e;
        void 0 !== a &&
          null != a &&
          ((a = a.split(";")),
  ...
  (e += m),
    (e += "@media (max-width: 1199px) { " + h + "}"),
    (e += "@media (max-width: 991px)  { " + b + "}"),
    (e += "@media (max-width: 767px)  { " + v + "}"),
    (e += "@media (max-width: 479px)  { " + x + "}"),
    (e += "/** Ultimate: Media Responsive - **/</style>"),
