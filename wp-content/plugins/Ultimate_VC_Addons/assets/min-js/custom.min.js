!(function (c) {
  ...
  function r(t, e) {
    ...
    (i = parseInt(e.outerHeight())),
      t.css("padding-top", (s = i / 2) + "px"),
      t.parent().css("margin-top", s + 20 + "px"),
      e.css("top", -i + "px");
  }
  function o(t) {
    0 < t.find(".timeline-icon-block").length &&
      c(".timeline-block").each(function (t, e) {
        ...
        c(this).hasClass("timeline-post-left")
          ? (s.css({ left: n, right: "auto" }),
            jQuery("body").hasClass("rtl") && s.css({ left: "auto", right: n }))
          : c(this).hasClass("timeline-post-right") &&
            (s.css({ left: "auto", right: n }),
            jQuery("body").hasClass("rtl") &&
              s.css({ left: n, right: "auto" }));
        n = i.height();
        s.css({ top: n / 2 - r / 2 });
        (n = s.offset().left), (r = c(window).width());
        (n < 0 || r < n + o) &&
          (s.css({
            position: "relative",
            top: "auto",
          ...
          s.children().children().css({ margin: "10px auto" }),
          i.css({ padding: "0" }));
      });
  }
  function i() {
      ...
      if (jQuery(this).attr("data-animate")) {
        ...
        if (a(jQuery(this))) {
          ...
          void 0 === t && (t = "test"),
            ...
            "opacity:0;" == t &&
              0 !== t.indexOf(i) &&
              jQuery(this).attr("style", i),
            jQuery.each(e, function (t, e) {
              const i = jQuery(e);
              let s = i.attr("style");
              void 0 === s && (s = "test");
              let r = "";
              (r = 0 == s.indexOf(n) ? s : n + s),
                i.attr("style", r),
                a(i) && i.addClass("animated").addClass(o);
            });
        }
      }
    });
  ...
  function a(t) {
    ...
    e =
      void 0 ===
        (e = jQuery(t).hasClass("ult-animate-viewport")
          ? jQuery(t).data("opacity_start_effect")
          : e) || "" == e
        ? 2
        : 100 - e;
  ...
  function n() {
    ...
    t.each(function (t, e) {
      ...
      i.hasClass("ult-ib-resp") &&
        ((s = jQuery(document).width()),
        (r = i.data("min-width")),
        s <= i.data("max-width") && r <= s
  ...
  (c.fn.vc_translate_row = function () {
    ...
    c(this).each(function (t, e) {
      ...
      if (
        ...
        var s = c(e).outerHeight(),
          r = c(e).offset().top - u,
          o = r + s,
          n = c(e).attr("data-parallax-content-sense") / 100,
          a = 0;
        (o <= l - 0 * l &&
          r <= 0 &&
          !((a = s > l ? (l - o) * n : -r * n) < 0)) ||
      ...
      c(this).each(function (t, e) {
        ...
        if (
          ...
          var s = 100 - (s = c(e).data("fadeout-percentage")),
            r = c(e).outerHeight(),
            o = c(e).offset().top - n + r;
          let i = 1;
          (r = a - a * (s / 100)), (s = ((r - o) / r) * 1);
          0 < s && (i = 1 - s),
            o <= r
              ? (i < 0 ? (i = 0) : 1 < i && (i = 1),
                c(e)
      ...
      !(function () {
        ...
        c(".ult-spacer").each(function (t, e) {
          var i = c(e).data("id"),
            ...
            n = c(e).data("height-tab-portrait"),
            e = c(e).data("height");
          "" != e && (a += " .spacer-" + i + " { height:" + e + "px } "),
            ("" == o && "0" != o && 0 != o) ||
              (a +=
          ...
          "" != a && ((a = "<style>" + a + "</style>"), c("head").append(a));
      })();
    }),
    ...
    jQuery(window).on("load", function () {
      jQuery(".ult-banner-block-custom-height").each(function (t, e) {
        ...
        i.width();
        r < s && i.css({ width: "100%", height: "auto" });
      }),
      ...
      jQuery(window).on("resize", function () {
        n(),
          ...
          jQuery(".smile-icon-timeline-wrap.jstime .timeline-line").css(
            ...
            ? 0 === s &&
              (c(".jstime .timeline-wrapper").masonry("destroy"), (s = 1))
            : 1 == s &&
        ...
        c(".smile-icon-timeline-wrap").each(function () {
          ...
          parseInt(jQuery(this).width()),
            parseInt(jQuery(this).find(".timeline-block").width());
          c(".jstime .timeline-wrapper").each(function () {
                ...
                jQuery(".smile-icon-timeline-wrap").each(function () {
                  ...
                  jQuery(this)
                    ...
                    0 < jQuery(this).find(".feat-item").find(".feat-top").length
                      ? jQuery(this)
                          .find(".feat-item l")
                          .css("border-top-color", t)
                      : jQuery(this)
                          .find(".feat-item l")
                          .css("border-bottom-color", t),
      ...
      /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(
        ...
        jQuery(".ubtn")
          .on("mouseenter", function () {
            ...
            setTimeout(function () {
              !1 !== e &&
                t.hasClass(".ubtn-fade-bg") &&
                t.css("background", t.data("hover-bg"));
            }, 150);
            let i = t.attr("style");
            var s;
            "" != t.data("shadow-hover") &&
              (t.css("box-shadow"),
              (i += "box-shadow:" + t.data("shadow-hover"))),
              t.attr("style", i),
              "" != t.data("border-hover") &&
                t.css("border-color", t.data("border-hover")),
              "none" != t.data("shadow-click") &&
                ((s = t.data("shd-shadow") - 3),
                "" != t.is(".shd-left")
                  ? t.css({ right: s })
                  : "" != t.is(".shd-right")
                  ? t.css({ left: s })
            ...
            "" != t.data("shadow-hover") &&
              ...
              "none" != t.data("shadow-click") &&
                ...
                "" != t.is(".shd-left")
                  ...
                  : "" != t.is(".shd-top")
                  ? t.css({ bottom: "auto" })
                  : "" != t.is(".shd-bottom") && t.css({ top: "auto" }));
          }),
            ...
            setTimeout(function () {
              e.is(":focus")
                ? (e.addClass("no-ubtn-shadow"),
                  "" != e.is(".shd-left")
                    ? e.css({ right: e.data("shd-shadow") + "px" })
                    : "" != e.is(".shd-right")
                    ? e.css({ left: e.data("shd-shadow") + "px" })
                    : "" != e.is(".shd-top")
                    ? e.css({ bottom: e.data("shd-shadow") + "px" })
                    : "" != e.is(".shd-bottom") &&
                      e.css({ top: e.data("shd-shadow") + "px" }))
                : (e.removeClass("no-ubtn-shadow"),
                  "" != e.is(".shd-left")
                    ...
                    : "" != e.is(".shd-top")
                    ? e.css({ bottom: "auto" })
                    : "" != e.is(".shd-bottom") && e.css({ top: "auto" }));
            }, 0);
        }),
        ...
        jQuery(".stats-block").each(function () {
          t(this).bsf_appear(function () {
            ...
            let o = jQuery(this).find(".stats-number").data("decimal"),
              n = e.split(".");
            n = n[1] ? n[1].length - 1 : 0;
            let a = !0;
            "none" == o && (o = ""), (a = "none" != r);
            r = { useEasing: !0, useGrouping: a, separator: r, decimal: o };
            const u = new countUp(s, 0, t, n, i, r);
            setTimeout(function () {
              u.start();
            }, 500);
          });
        ...
        /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(
          ...
          ? jQuery(".ifb-flip-box").on("click", function (t) {
              const e = jQuery(this);
              e.hasClass("ifb-hover")
                ? e.removeClass("ifb-hover")
                : e.addClass("ifb-hover");
            })
          : jQuery(document).on(
        ...
        jQuery(".square_box-icon").each(function (t, e) {
          ...
          0 < jQuery(this).find(".aio-icon-img").length
            ? ((s = jQuery(this).find(".aio-icon-img")),
              r(i, s),
              s.find(".img-icon").on("load", function () {
                r(i, s);
              }))
            : ((s = jQuery(this).find(".aio-icon")),
              r(i, s),
              jQuery(window).on("load", function () {
                r(i, s);
              }));
  ...
  jQuery(document).ready(function () {
    function i() {
      jQuery(".ultimate-map-wrapper").each(function (t, e) {
        ...
        let o = "true";
        jQuery("#" + s).css({ "margin-left": 0 }),
          jQuery("#" + s).css({ right: 0 });
        let n = jQuery("#" + i).parent();
        n;
        if (
          ("full" == r && ((n = jQuery("body")), (o = "false")),
          "ex-full" == r && ((n = jQuery("html")), (o = "false")),
          !isNaN(r))
        )
          for (t = 0; t < r && "HTML" != n.prop("tagName"); t++) n = n.parent();
        e = 0 == r || "0" == r ? n.width() : n.outerWidth();
        i = n.offset().left - jQuery("#" + s).offset().left;
        if (
          (jQuery("#" + s).css({ width: e }),
          (0 == r && "0" == r) || jQuery("#" + s).css({ "margin-left": i }),
          "full" == r && jQuery("body").hasClass("rtl"))
        ) {
          const a = jQuery("#" + s);
          i = jQuery(window).width() - (a.offset().left + a.outerWidth());
          jQuery("#" + s).css({ right: -i });
        }
      });
    }
    i(),
      ...
      jQuery(".ui-tabs").on("tabsactivate", function (t, e) {
        0 < jQuery(this).find(".ultimate-map-wrapper").length && i();
      }),
      jQuery(".ui-accordion").on("accordionactivate", function (t, e) {
        0 < jQuery(this).find(".ultimate-map-wrapper").length && i();
      }),
