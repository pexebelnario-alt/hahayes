    ...
    if (!$(el).data("bxSlider")) {
      var init = function () {
          $(el).data("bxSlider") ||
            ...
            (slider.animProp =
              "vertical" === slider.settings.mode ? "top" : "left"),
            (slider.usingCSS =
        ...
        setup = function () {
          ...
          el.wrap(
            ...
            el.css({
              width:
                "horizontal" === slider.settings.mode
                  ? 1e3 * slider.children.length + 215 + "%"
                  : "auto",
              position: "relative",
            }),
            slider.usingCSS && slider.settings.easing
              ? el.css(
                  "-" + slider.cssPrefix + "-transition-timing-function",
                  slider.settings.easing
                )
              : slider.settings.easing || (slider.settings.easing = "swing"),
            slider.viewport.css({
              width: "100%",
              overflow: "hidden",
              position: "relative",
            ...
            "none" === slider.settings.preloadImages
              ? (preloadSelector = null)
              : ("all" === slider.settings.preloadImages ||
                  slider.settings.ticker) &&
        ...
        start = function () {
          ...
          slider.loader.remove(),
            ...
            slider.settings.responsive && $(window).on("resize", resizeWindow),
            slider.settings.auto &&
            ...
            slider.settings.touchEnabled &&
              !slider.settings.ticker &&
              initTouch(),
            slider.settings.keyboardEnabled &&
              !slider.settings.ticker &&
        ...
        getViewportHeight = function () {
          ...
          if (
            ...
            if (slider.carousel) {
              ...
              for (
                ...
                children =
                  currentIndex + i >= slider.children.length
          ...
          return (
            ...
            "border-box" === slider.viewport.css("box-sizing")
              ...
              : "padding-box" === slider.viewport.css("box-sizing") &&
                (height +=
                  parseFloat(slider.viewport.css("padding-top")) +
                  parseFloat(slider.viewport.css("padding-bottom"))),
            height
        ...
        getMoveBy = function () {
          return slider.settings.moveSlides > 0 &&
            slider.settings.moveSlides <= getNumberSlidesShowing()
            ? slider.settings.moveSlides
            : getNumberSlidesShowing();
        },
        setSlidePosition = function () {
          ...
          !slider.settings.infiniteLoop
            ? "horizontal" === slider.settings.mode
              ? ((position = (lastChild = slider.children.last()).position()),
                setPositionProperty(
                  -(
                    position.left -
          ...
          for (
            ...
            (linkContent = ""),
              (slider.settings.buildPager &&
                "function" == typeof slider.settings.buildPager) ||
        ...
        appendControlsAuto = function () {
          (slider.controls.start = $(
            ...
            slider.settings.autoControlsSelector
        ...
        clickNextBind = function (e) {
          e.preventDefault(),
            slider.controls.el.hasClass("disabled") ||
              (slider.settings.auto &&
                slider.settings.stopAutoOnClick &&
                el.stopAuto(),
              el.goToNextSlide());
        },
          ...
          e.preventDefault(),
            slider.controls.el.hasClass("disabled") ||
              (slider.settings.auto &&
                ...
                el.stopAuto(),
              void 0 !==
                (pagerLink = $(e.currentTarget)).attr("data-slide-index") &&
        ...
        updatePagerActive = function (slideIndex) {
          ...
          if ("short" === slider.settings.pagerType)
            return (
              slider.settings.maxSlides > 1 &&
                (len = Math.ceil(
                  slider.children.length / slider.settings.maxSlides
                )),
              void slider.pagerEl.html(
        ...
        initAuto = function () {
          slider.settings.autoDelay > 0
            ? setTimeout(el.startAuto, slider.settings.autoDelay)
            : (el.startAuto(),
              $(window)
                .on("focus", windowFocusHandler)
                .no("blur", windowBlurHandler)),
            slider.settings.autoHover &&
              el.hover(
                function () {
                  slider.interval &&
                    (el.stopAuto(!0), (slider.autoPaused = !0));
                },
                function () {
                  slider.autoPaused &&
                    (el.startAuto(!0), (slider.autoPaused = null));
                }
              );
        },
        initTicker = function () {
                      ...
                      (totalDimens = 0),
                        ...
                        (property =
                          "horizontal" === slider.settings.mode
                            ? "left"
                            : "top"),
                        "prev" === slider.settings.autoDirection &&
                          (newSpeed =
                            ratio * (totalDimens + Math.abs(parseInt(value))) -
                ...
                : slider.viewport.hover(
                    ...
                    function () {
                      (totalDimens = 0),
                        ...
                        (newSpeed =
                          ratio *
                          (totalDimens + Math.abs(parseInt(el.css(property))))),
                        tickerLoop(newSpeed);
                    }
                  )),
            tickerLoop();
          ...
          "next" === slider.settings.autoDirection
            ...
            (animateProperty =
              "horizontal" === slider.settings.mode
                ...
                : -position.top),
            (resetValue =
              "horizontal" === slider.settings.mode ? -reset.left : -reset.top),
            setPositionProperty(
              animateProperty,
              "ticker",
              speed,
        ...
        keyPress = function (e) {
          var activeElementTag = document.activeElement.tagName.toLowerCase(),
            ...
            result;
          if (
            null == new RegExp(activeElementTag, ["i"]).exec(tagFilters) &&
            isOnScreen(el)
          ) {
        ...
        initTouch = function () {
          (slider.touch = { start: { x: 0, y: 0 }, end: { x: 0, y: 0 } }),
            ...
            slider.viewport.on("click", ".bxslider a", function (e) {
              slider.viewport.hasClass("click-disabled") &&
                (e.preventDefault(),
          ...
          if ("touchstart" === e.type || 0 === e.button)
            if (
              ...
              var orig = e.originalEvent,
                touchPoints =
                  void 0 !== orig.changedTouches ? orig.changedTouches : [orig],
                chromePointerEvents;
              if (
                "function" == typeof PointerEvent &&
                void 0 === orig.pointerId
              )
                return;
        ...
        onTouchMove = function (e) {
          var orig = e.originalEvent,
            ...
            change = 0;
          (slider.hasMove = !0),
            3 * xMovement > yMovement && slider.settings.preventDefaultSwipeX
              ? e.preventDefault()
              : 3 * yMovement > xMovement &&
          ...
          (slider.touch.end.x = touchPoints[0].pageX),
            ...
            "fade" === slider.settings.mode
              ...
              : ("horizontal" === slider.settings.mode
                ...
                !slider.settings.infiniteLoop &&
                ((0 === slider.active.index && distance > 0) ||
            ...
            slider.viewport.get(0).releasePointerCapture &&
              slider.viewport.get(0).releasePointerCapture(slider.pointerId),
            !1 !== slider.hasMove ||
              (0 !== slider.originalClickButton &&
                "touchstart" !== slider.originalEventType) ||
      ...
      return (
        (el.goToSlide = function (slideIndex, direction) {
          ...
          if (
            ...
            "next" === direction
              ...
              (slider.settings.pager || slider.settings.pagerCustom) &&
              ...
              "fade" === slider.settings.mode
                ...
                : (slider.settings.adaptiveHeight &&
                  ...
                  slider.active.last
                    ? "horizontal" === slider.settings.mode
                      ? ((position = (lastChild = slider.children.eq(
        ...
        (el.goToNextSlide = function () {
          if (
            (slider.settings.infiniteLoop || !slider.active.last) &&
            !0 !== slider.working
          ) {
        ...
        (el.goToPrevSlide = function () {
          if (
            (slider.settings.infiniteLoop || 0 !== slider.active.index) &&
            !0 !== slider.working
          ) {
            var pagerIndex = parseInt(slider.active.index) - 1;
        ...
        (el.startAuto = function (preventControlUpdate) {
          slider.interval ||
            ...
            slider.settings.autoControls &&
              !0 !== preventControlUpdate &&
              updateAutoControls("stop"));
        }),
        (el.stopAuto = function (preventControlUpdate) {
          slider.autoPaused && (slider.autoPaused = !1),
            slider.interval &&
        ...
        (el.redrawSlider = function () {
          slider.children.add(el.find(".bx-clone")).outerWidth(getSlideWidth()),
            ...
            slider.settings.pager &&
              !slider.settings.pagerCustom &&
              (populatePager(), updatePagerActive(slider.active.index)),
            slider.settings.ariaHidden &&
              applyAriaHiddenAttributes(slider.active.index * getMoveBy());
        }),
        (el.destroySlider = function () {
          slider.initialized &&
            ...
            clearInterval(slider.interval),
            slider.settings.responsive && $(window).off("resize", resizeWindow),
            slider.settings.keyboardEnabled &&
