!(function () {
  ...
  (_tpt.distAlpha = (t, e, r, n, i) =>
    ...
    (_tpt.registerImage = function (t, e = 0, r, n, i, s = !0) {
      ...
      (a = -1 == a ? _tpt.R.images.alllen++ : a),
        ...
        clearTimeout(_tpt.R.images.uiqTimer),
        (_tpt.R.images.uiqTimer = setTimeout(_tpt.updateImageQueue, 50));
    }),
        ...
        if (null == _tpt.R.images.queue[r])
          for (t = e; t < _tpt.R.images.alllen; t++)
            if ("pending" == _tpt.R.images.all[t].state) {
              (_tpt.R.images.queue[r] = t),
                (_tpt.R.images.all[t].state = "inqueue"),
                (e = t);
              break;
            }
    ...
    (_tpt.processImageQueue = function () {
      for (var t = 0; t < 5; t++)
        void 0 !== _tpt.R.images.queue[t] &&
          "inqueue" == _tpt.R.images.all[_tpt.R.images.queue[t]].state &&
          ((_tpt.R.images.all[_tpt.R.images.queue[t]].state = "loading"),
          this.tryLoadImage(_tpt.R.images.queue[t], t));
    }),
    ...
    (_tpt.tryLoadImage = function (t, e, r = !1) {
      ...
      _tpt
        .loadSingleImage(n.url, e, i)
        .then((t) => {
          let e = _tpt.findRequestedImage(t.image.src);
          (_tpt.R.images.all[e].state = t.status),
            (_tpt.R.images.all[e].image = t.image),
            (_tpt.R.images.all[e].index = e),
            (_tpt.R.images.all[e].width = t.image.width),
            (_tpt.R.images.all[e].height = t.image.height),
            _tpt.processImageCallbacks(e, t.queueIndex);
        })
        .catch((n) => {
          if (r) {
            var i = _tpt.R.images.queue[e];
            (_tpt.R.images.all[i].state = n.status),
              (_tpt.R.images.all[i].index = i),
              _tpt.processImageCallbacks(i, e),
              console.log(
                "Image Error: " +
                  _tpt.R.images.all[i].url +
                  " could not be loaded"
              );
    ...
    (_tpt.R.tptools = _tpt.extend
      ? _tpt.extend(_tpt.R.tptools, { status: 2, version: "6.7.15" })
  ...
  (() => {
     ...
     */ var r,
      ...
      Lt = function (t, e) {
        ...
        if (
          ((e._time ||
            ...
            ((r = Pt(t.rawTime(), e)),
            (!e._dur || Ut(0, e.totalDuration(), r) - e._tTime > y) &&
              e.render(r, !0)),
      ...
      It = function (t, e) {
        return (
          (G.ScrollTrigger || W("scrollTrigger", e)) &&
          ...
          function (e) {
            ...
            return Jt(
              ...
              r.querySelectorAll
                ? r
                : r === t
                ? U("Invalid scope") || u.createElement("div")
                : t
            );
          }
        );
        ...
        G.SteppedEase =
          {
            config: function (t, e) {
              ...
              var r = 1 / t,
                ...
                i = e ? 1 : 0;
              return function (t) {
                return (((n * Ut(0, 0.99999999, t)) | 0) + i) * r;
              };
            },
          }),
      (D.ease = Ce["quad.out"]),
        ...
        return (
          ...
          (e.timeScale = function (t, e) {
            ...
            return (
              ...
              this.totalTime(
                Ut(-Math.abs(this._delay), this._tDur, r),
                !1 !== e
              ),
              kt(this),
              (function (t) {
    ...
    var Ne = (function (r) {
      ...
      return (
        ...
        (o.staggerFrom = function (t, e, r, n, i, s, o) {
          return (
            (r.runBackwards = 1),
            (Ct(r).immediateRender = R(r.immediateRender)),
        ...
        (o.staggerFromTo = function (t, e, r, n, i, s, o, a) {
          return (
            (n.startAt = r),
            (Ct(n).immediateRender = R(n.immediateRender)),
    ...
    var Ie,
            ...
            (o = new nt[t]()).init(
              ...
              o.rawVars
                ...
                : (function (t, e, r, n, i) {
                    if (
                      (S(t) && (t = Ve(t, i, e, r, n)),
                      !O(t) || (t.style && t.nodeType) || L(t) || B(t))
                    )
      ...
      qe = function t(e, i, o) {
        ...
        if (
          ...
          for (
            e._pt = e._ptCache = 0, T = (k && R(T)) || (T && !k), u = 0;
            u < L.length;
            u++
          ) {
            if (
                ...
                for (
                  ...
                  if (!u)
                    return (
                      ...
                      qe(t, o),
                      (ze = 0),
                      a ? U(e + " not eligible for reset") : 1
                    );
                  h.push(u);
                }
              for (c = h.length; c--; )
    ...
    (Ue.version = Ne.version = xr.version = "3.12.5"),
      (l = 1),
      P() && we(),
      Ce.Power0,
      Ce.Power1,
    ...
    var br,
      ...
      Sn = function (t, e) {
        ...
        return (
          ...
          (r.force3D = m.force3D),
          (r.renderTransform = r.svg ? Ln : Mr ? Bn : On),
          (r.uncache = 0),
          r
        );
      },
      ...
      hi = function (t, e, r, n, i, s, o) {
            ...
            ((h = (p = c[a]).parentNode === t) || N || (L && !B)) &&
              ...
              k &&
                (((p._isSplit && h) ||
                  ...
                  (f.push(p), (p._x -= y), li(p, t, O) && (p._wordEnd = !0)),
                "BR" === p.nodeName &&
          ...
          if (((h = (p = c[a]).parentNode === t), "BR" !== p.nodeName))
            if (
              ...
              if (p._isSplit)
                ...
                p.parentNode._isSplit
                  ? ((p._parent = p.parentNode),
                    ...
                    l--)
                  : h ||
                    ((D = !p.nextSibling && li(p.parentNode, t, O)),
                    p.parentNode._parent && p.parentNode._parent.appendChild(p),
                    D && p.parentNode.appendChild(Wn.createTextNode(" ")),
              ...
              p.parentNode._isSplit && !p._isSplit && "" !== p.innerHTML
                ...
                : L &&
                  !p._isSplit &&
                  ("span" === R && (p.style.display = "inline"), S.push(p));
          else
            k || N
        ...
        if (k) {
          ...
          for (d = " " === O && (!N || (!B && !L)), a = 0; a < k.length; a++) {
            for (
              f = k[a],
                (_ = Wn.createElement(R)).style.cssText =
              ...
              "BR" !== f[u].nodeName &&
                ((p = f[u]),
                _.appendChild(p),
                d && p._wordEnd && _.appendChild(Wn.createTextNode(" ")),
                N &&
                  (0 === u &&
                    ((_.style.top = p._y + "px"),
                    (_.style.left = y + D + "px")),
    ...
    function Zi(t, e, r, n, i, s, o, a, u) {
      if (t !== a || e !== u) {
        ...
        var C = (s === o ? -1 : 1) * Fi(w),
          ...
          B =
            (M * R - A * O < 0 ? -1 : 1) *
            Math.acos((M * O + A * R) / Fi(P * (O * O + R * R)));
        isNaN(B) && (B = h),
          !o && B > 0 ? (B -= f) : o && B < 0 && (B += f),
          (k %= f),
          (B %= f);
     ...
     */ var yo,
      ...
      zo = {
        ...
        init: function (t, e, r) {
          ...
          if (
            ...
            g))
              i !== f &&
                i !== d &&
                a.push(Ro(this, Mo([], l, i, 2), t, i, 0, _, e, bo(l[0][i])));
          } else
        ...
        arrayToRawPath: function (t, e) {
          ...
          return (
            e.relative && Oo(r), ["cubic" === e.type ? r : ts(r, e.curviness)]
          );
        },
      };
    function Xo(t) {
        ...
        function n(e, r) {
          ...
          var s,
                  ...
                  Q = !1,
                    ...
                    Oa.scrollLeft =
                      null != Yo.pageXOffset
                        ...
                        : ot.body.scrollLeft,
                    a = H.pointerX - Oa.scrollLeft,
                    u = H.pointerY - Oa.scrollTop;
                  f && !i;

                )
                  (n = (i = Ha(f.parentNode)) ? Oa : f.parentNode),
                    (s = i
                      ? {
                          bottom: Math.max(
                            Go.clientHeight,
            ...
            vt = function (t, i) {
              ...
              if (
                ...
                if (
                  ...
                  Ka(H, "pressInit", "onPressInit"),
                  (A || H.autoScroll) && Ua(e.parentNode),
                  !e.parentNode ||
                    !H.autoScroll ||
                    o ||
                    X ||
                    ...
                    Wo.parentNode ||
                    e.getBBox ||
                    ((Wo.style.width = e.parentNode.scrollWidth + "px"),
                    e.parentNode.appendChild(Wo)),
                  _t(),
                  H.tween && H.tween.kill(),
                  (H.isThrowing = !1),
                  jo.killTweensOf(o || e, U, !0),
            ...
            yt = function (t) {
              ...
              if (s && !ta && H.isPressed && t) {
                ...
                (((l = Math.abs(n - a)) !== (p = Math.abs(i - u)) &&
                  ...
                  (ea && A === O)) &&
                  ((O = l > p && q ? "x" : "y"),
                  A && O !== A && Na(Yo, "touchforcechange", za),
                  !1 !== H.vars.lockAxisOnTouchScroll &&
                    q &&
                    G &&
                    ((H.lockedAxis = "x" === O ? "y" : "x"),
            ...
            bt = function t(n, i) {
              if (
                ...
                for (a = W.length; --a > -1; )
                  $a(W[a], "cursor", r.cursor || (!1 !== r.cursor ? na : null));
                if ((la--, n)) {
                  if (
                    (o = n.changedTouches) &&
                    (n = o[0]) !== D &&
          ...
          return (
              ...
              if ((lt(!0), ct(), c && !mt())) {
                if (
                  ...
                  for (
                    ...
                    (u = (l = Ha(a.parentNode)) ? Oa : a.parentNode),
                      G &&
            ...
            (i.disable = function (t) {
              for (var r, n = H.isDragging, i = W.length; --i > -1; )
                $a(W[i], "cursor", null);
              if ("soft" !== t) {
                for (Pa(W, null), i = W.length; --i > -1; )
                  (r = W[i]),
            ...
            (i.kill = function () {
              return (
                ...
                H.tween && H.tween.kill(),
                H.disable(),
                jo.set(W, { clearProps: "userSelect" }),
            ...
            ~I.indexOf("scroll") &&
              ...
              (e = o.content)),
            X ? (U.rotation = 1) : (q && (U[j] = 1), G && (U[Y] = 1)),
                    ...
                    nl[o] ||
                      ...
                      Vu(a) &&
                        ...
                        "max" in a && c > +a.max + 1e-10
                          ? ((d = a.unitFactor || Ru.unitFactors[o] || 1),
                            (h =
                              (p > a.max && a.min !== a.max) ||
                              (l * d > -15 && l * d < 45)
                                ? n + 0.1 * (r - n)
    ...
    "track,untrack,isTracking,getVelocity,getByTarget"
      ...
      qn.registerPlugin(Ue, Gn, Ne, Ne, Yn, gi, ks, ps, Ys, Js, zo, lu, ol),
      (window._tpt ??= {});
