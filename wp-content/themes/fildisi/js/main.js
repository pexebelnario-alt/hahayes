...
(function ($) {
  ...
  EUTHEM.documentReady = {
    init: function () {
      ...
      EUTHEM.slideToggleMenu.init(
        "#eut-hidden-menu",
        "#eut-hidden-menu .eut-menu"
      );
      EUTHEM.slideToggleMenu.init(
        "#eut-main-header.eut-header-side",
        "#eut-main-menu.eut-vertical-menu .eut-menu"
      );
    ...
    init: function () {
      ...
      if (window.location.hash) {
        setTimeout(function () {
          ...
          if ($(target).length) {
            if (
              $(target).hasClass("eut-tab-content") ||
              $(target).hasClass("eut-accordion-content")
            ) {
              var tabLink = $(
                '.eut-tab-link[data-rel="' + target + '"]:visible'
              );
              if (tabLink.length) {
                tabLink.click();
                setTimeout(function () {
  ...
  EUTHEM.stickyHeaderTypes = {
    init: function () {
      var $header = $("#eut-header"),
        ...
        stickyHeader = $stickyHeader.hasClass("eut-header-logo-top")
          ? "#eut-bottom-header"
          : "#eut-main-header",
        stickyType = $header.data("sticky"),
        stickyDevice = $header.data("devices-sticky"),
        responsiveThreshold =
          parseInt(fildisi_eutf_main_data.responsive_thershold) - 1;
  ...
  EUTHEM.stickyHeader = {
    ...
    init: function (settings) {
      ...
      function setup() {
        ...
        updateParams();
        if (
          windowW + scrollBarWidth > minWidth &&
          windowW + scrollBarWidth < maxWidth
        ) {
          update();
      ...
      function updateParams() {
        wpBarHeight =
          $("body").hasClass("admin-bar") && $(window).width() > 783 ? 32 : 0;
        wpBarHeight =
        ...
        windowW = $(window).width();
        frameSize =
          $("body").hasClass("eut-framed") &&
          windowW + scrollBarWidth > tabletPortrait
            ? $("#eut-frames").data("frame-size")
            : 0;
        headerT = getOffset($header);
        topbarH =
          $("#eut-top-bar").length &&
          ($("#eut-top-bar").hasClass("eut-sticky-topbar") ||
            $("#eut-top-bar").hasClass("eut-device-sticky-topbar"))
            ? $("#eut-top-bar").outerHeight()
            : 0;
  ...
  EUTHEM.advancedHiddenMenu = {
    init: function () {
      ...
      if (!$menu.length || !$header.hasClass("eut-advanced-hidden-menu"))
        return;
      ...
      $leaderElement.each(function () {
        ...
        function setLeaderHeight() {
          if (
            ...
            windowWidth + scrollBarWidth > tabletPortrait
          ) {
            $leaderPost.css({
              height: maxHeight,
              visibility: "visible",
  ...
  EUTHEM.anchorSticky = {
    init: function () {
      ...
      if (base.$anchor.length) {
        ...
        base.$mElements = $(
          "#eut-fildisi-sticky-header .eut-header-elements-wrapper"
        );
    ...
    setVars: function () {
      ...
      base.topBarH =
        base.$topBar.length && base.styckyType != "none"
          ? base.$topBar.outerHeight()
          : 0;
      base.headerH =
        base.$stickyHeader != undefined ? base.$stickyHeader.outerHeight() : 0;
      base.frameSize = $("#eut-frames").length
        ? $("#eut-frames").data("frame-size")
        : 0;
      base.mLogoW = base.$mLogo.length ? base.$mLogo.outerWidth() : 0;
      base.mElementsW = base.$mElements.length
        ? base.$mElements.outerWidth()
        : 0;
    ...
    update: function () {
      ...
      if (
        base.headerH != 0 &&
        base.styckyType != "none" &&
        base.styckyType != "simple"
      ) {
        base.setNewHeight();
      }
      ...
      if (scroll >= topOffset) {
        sticky = true;
        base.$anchorWrapper.addClass("eut-sticky").css({ top: topPos });
      } else {
        sticky = false;
        base.$anchorWrapper.removeClass("eut-sticky").css({ top: "" });
      }
      if (base.styckyType === "fildisi") {
    ...
    doTranslate: function (value) {
      return {
        "-webkit-transform":
          "translate3d(0px, " + value + "px, 0px) translateZ(0)",
        "-moz-transform":
          "translate3d(0px, " + value + "px, 0px) translateZ(0)",
    ...
    fildisiAnchor: function (sticky) {
      ...
      var rightPos = $("body").hasClass("eut-boxed")
        ? "auto"
        : base.mElementsW + 2;
  ...
  EUTHEM.slideToggleMenu = {
    init: function (parrent, element) {
      ...
      var $menu = $(element),
        ...
        $goBack = $(
          '<li class="eut-goback"><a href="#"><i class="eut-arrow"></i></a></li>'
        );
    ...
    init: function () {
      ...
      $stickyWidget.each(function () {
        ...
        if ($this.length > 0) {
          ...
          if (sidebarWidget && $("#eut-sidebar").hasClass("eut-fixed-sidebar"))
            return;

          var $content = sidebarWidget
              ? $("#eut-main-content .eut-main-content-wrapper")
              : $this.parents(".eut-row"),
            $sidebar = $this.parent(),
            headerHeight =
              $("#eut-header").data("sticky") != "none"
                ? $("#eut-header").data("sticky-height")
                : 0,
            anchorHeight = $(".eut-anchor-menu").length
              ? $(".eut-anchor-menu").outerHeight()
              : 0,
        ...
        function updateSidebarPosition() {
          ...
          if (scrollTop < sidebarTop - topOffset) {
            ...
            scrollTop >= sidebarTop - topOffset &&
            scrollTop < sidebarTop + contentHeight - sidebarHeight - topOffset
          ) {
            $sidebar
              .addClass("fixed")
              .css({
        ...
        if (scrollTop < sidebarTop - topOffset + contentPadding) {
          ...
          if ($sidebarWrapper.hasClass("fixed")) {
            $sidebarWrapper
              .removeClass("fixed")
              .css({
                top: contentHeight - sidebarHeight - bottomOffset + "px",
                position: "relative",
              });
          }
        }
  ...
  EUTHEM.featureSize = {
    init: function (section) {
      ...
      this.frameSize = $("body").hasClass("eut-framed")
        ? $("#eut-frames").data("frame-size")
        : 0;
      this.updateParams();
      var featureHeight;
    ...
    getHeaderHeight: function () {
      ...
      if (
        ...
        !this.header.hasClass("eut-overlapping") &&
        !this.header.hasClass("eut-header-below")
      ) {
        height = this.header.outerHeight();
      }

      if (
        this.responsiveHeader.length &&
        this.responsiveHeader.is(":visible") &&
        !this.header.hasClass("eut-responsive-overlapping") &&
        !this.header.hasClass("eut-header-below")
      ) {
    ...
    fullscreenSize: function () {
      var sectionH =
        this.windowH - this.headerH - this.topBarH - this.frameSize * 2;
      this.$section
        .css("height", sectionH)
        .find(".eut-wrapper")
        .css("height", sectionH);
    ...
    init: function (section) {
      ...
      function featureSlider() {
        var $slider = $("#eut-feature-slider"),
          ...
          sliderSpeed = parseInt($slider.attr("data-slider-speed"))
            ? parseInt($slider.attr("data-slider-speed"))
            : 6000,
          ...
          function (event) {
            var current = event.item.index,
              $currentSlide = $(event.target)
                .find(".eut-slider-item-wrapper")
                .eq(current),
              sliderColor = $currentSlide
                .find(".eut-slider-item")
                .attr("data-header-color"),
            ...
            if (!$("#eut-main-header").hasClass("eut-header-side")) {
              $("#eut-main-header")
                .removeClass("eut-light eut-dark")
                .addClass(color);
            }

            // Set Navigation Color
            $("#eut-feature-section .eut-carousel-navigation")
              .removeClass("eut-light eut-dark eut-default")
              .addClass(color);
      ...
      function featureAnimation(section) {
        ...
        $.each(contentItems, function (key, item) {
          $(item).removeClass(
            "eut-animate-fade-in eut-animate-fade-in-up eut-animate-fade-in-down eut-animate-fade-in-left eut-animate-fade-in-right eut-animate-zoom-in eut-animate-zoom-out"
          );
  ...
  EUTHEM.featureParallax = {
    init: function () {
      ...
      if (
        !section.hasClass("eut-bg-parallax") &&
        !section.hasClass("eut-bg-advanced-parallax") &&
        !section.hasClass("eut-bg-fixed-section")
      ) {
        return;
      }
  ...
  EUTHEM.wooThumbCarousel = {
    init: function () {
      var $thumbs = $("#eut-product-feature-image").find(".thumbnails"),
        ...
        $arrowNext = $(
          '<i class="eut-icon-nav-down-small eut-arrow-next"></i>'
        ),
        wrapper = false,
        smallDelay,
        wrapperH,
      ...
      function addWrapper() {
        if (!wrapper) {
          for (
            ...
            i < len;
            i += wooThumbCarouselItems
          ) {
            $items
              .slice(i, i + wooThumbCarouselItems)
              .wrapAll('<div class="eut-thumb-wrapper"/>');
          }
      ...
      function setSlider() {
        if ($(window).width() + scrollBarWidth < tabletPortrait && wrapper) {
          ...
          $(window).width() + scrollBarWidth > tabletPortrait &&
          !wrapper
        ) {
          addWrapper();
        }
  ...
  EUTHEM.pageSettings = {
    ...
    addVideoBg: function () {
      ...
      function insertYouTubeVideo($element, youtubeId, counter) {
        ...
        var startSeconds =
          $element.data("video-start") != undefined
            ? parseInt($element.data("video-start"))
            : 0;
        var endSeconds =
          $element.data("video-end") != undefined
            ? parseInt($element.data("video-end"))
            : 0;
        var $container = $element
          .prepend(
            '<div class="eut-bg-youtube-video"><div class="inner"></div></div>'
          )
          .find(".inner");
    ...
    resizeVideoBgElement: function ($element) {
      ...
      if (
        $element.hasClass("eut-yt-bg-video") ||
        $element.hasClass("eut-iframe-bg-video")
      ) {
        videoEl = "iframe";
      } else {
        videoEl = "video";
    ...
    removeVideoBg: function () {
      $(".eut-background-wrapper").each(function () {
        ...
        var bgVideoDevice =
          $bgVideo.data("videoDevice") != undefined
            ? $bgVideo.data("videoDevice")
            : "no";
    ...
    linkGoToTop: function (element, delay, space) {
      var $this = element,
        ...
        header =
          $("#eut-header").length && $("#eut-main-header").is(":visible")
            ? true
            : false,
        responsiveHeader =
          $("#eut-responsive-header").length &&
          $("#eut-responsive-header").is(":visible")
            ? true
            : false,
        headerHeight =
          header && $("#eut-header").data("sticky") != "none"
            ? $("#eut-main-header").outerHeight()
            : 0,
        respHeaderH =
          responsiveHeader && $("#eut-header").data("devices-sticky") == "yes"
            ? $("#eut-responsive-header").outerHeight()
            : 0,
        topBarHeight = $("#eut-top-bar").length
          ? $("#eut-top-bar").height()
          : 0,
        anchorBarHeight = $(".eut-anchor-menu").length
          ? $(".eut-anchor-menu").outerHeight()
          : 0,
    ...
    mainMenu: function () {
      ...
      $mainMenu.superfish({
        ...
        onBeforeShow: function () {
          ...
          if (
            $("body").hasClass("eut-boxed") &&
            ($li.hasClass("megamenu column-3") ||
              $li.hasClass("megamenu column-2"))
          ) {
    ...
    columnFullHeight: function () {
      ...
      $column.each(function () {
        var $that = $(this),
          fullTabletL =
            $that.data("tablet-landscape-fullheight") != undefined
              ? false
              : true,
          fullTabletP =
            $that.data("tablet-portrait-fullheight") != undefined
              ? false
              : true,
          fullMobileL =
            $that.data("mobile-fullheight") != undefined ? false : true;
    ...
    columnCustomSize: function () {
      ...
      $section.each(function () {
        ...
        if (
          $that.hasClass("eut-equal-column") ||
          $that.hasClass("eut-middle-content")
        ) {
          equal = true;
          equalTabletL =
            $that.data("tablet-landscape-equal-columns") != undefined
              ? false
              : true;
          equalTabletP =
            $that.data("tablet-portrait-equal-columns") != undefined
              ? false
              : true;
          equalMobileL =
            $that.data("mobile-equal-columns") != undefined ? false : true;
        }
    ...
    columnEffect: function () {
      ...
      $parallaxColumn.each(function () {
        var $that = $(this),
          ...
          tabletL =
            $that.data("tablet-landscape-parallax-effect") != "none" &&
            parallaxEffect == "vertical-parallax"
              ? true
              : false,
          tabletP =
            $that.data("tablet-portrait-parallax-effect") != "none" &&
            parallaxEffect == "vertical-parallax"
              ? true
              : false,
          mobileL =
            $that.data("mobile-parallax-effect") != "none" &&
            parallaxEffect == "vertical-parallax"
              ? true
              : false,
    ...
    eutModal: function () {
      var $button = $(".eut-toggle-modal"),
        $overlay = $(
          '<div id="eut-modal-overlay" class="eut-body-overlay"></div>'
        ),
        $closeBtn = $(
          '<div class="eut-close-modal"><i class="eut-icon-close"></i></div>'
        ),
      ...
      $button.on("click", function (e) {
        ...
        if (content.indexOf("#") === 0 && $(content).length > 0) {
          ...
          $(content).on("click", function (e) {
            if (
              !$(".eut-modal-item").is(e.target) &&
              $(".eut-modal-item").has(e.target).length === 0
            ) {
              e.preventDefault();
              closeModal();
            }
    ...
    bgLoader: function () {
      var $selector = $(
        "#eut-header .eut-bg-image, #eut-content .eut-bg-image, #eut-footer .eut-bg-image, .eut-navigation-bar .eut-bg-image, #eut-sidearea .eut-bg-image"
      );
    ...
    fitVid: function () {
      ...
      $('iframe[src*="youtube"]')
        .parent(":not(.eut-bg-youtube-video)")
        .fitVids();
      ...
      $btn.on("click", function (e) {
        ...
        if (content.indexOf("#") === 0 && $(content).length > 0) {
          ...
          $overlay = $(
            '<div id="' +
              overlayId +
              '-overlay" class="eut-body-overlay"></div>'
          );
          ...
          $link.on("click", function () {
            ...
            if (
              target.length &&
              (target.hasClass("eut-section") ||
                target.hasClass("eut-bookmark") ||
                target.hasClass("eut-tab-content") ||
                target.hasClass("eut-accordion-content"))
            ) {
              closeHiddenArea();
      ...
      function hiddenAreaWidth(area) {
        ...
        if ($(window).width() + scrollBarWidth <= mobileScreen) {
          ...
          if ($area.hasClass("eut-large-width")) {
            $(area).css({
              width: Math.max(hiddenaAreaMinWidth, windowWidth / 2),
            });
          } else if ($area.hasClass("eut-medium-width")) {
            $(area).css({
              width: Math.max(hiddenaAreaMinWidth, windowWidth / 3),
            });
          } else {
            $(area).css({
    ...
    hiddenAreaHeight: function (area) {
      ...
      var windowWidth = $(window).width(),
        ...
        hiddenAreaHeight =
          $(area).find(".eut-hiddenarea-content").outerHeight() + 200,
        $themeWrapper = $("#eut-theme-wrapper"),
    ...
    backtoTop: function () {
      var selectors = {
        ...
        footerBarHeight = $(".eut-footer-bar.eut-fullwidth").length
          ? $(".eut-footer-bar.eut-fullwidth").outerHeight()
          : 0;
      ...
      if ($(selectors.topBtn).length) {
        $(window).on("scroll", function () {
          ...
          if (
            ...
            $(document).height() - footerBarHeight
          ) {
            $topBtn.css({
      ...
      function horizontalBg($this) {
        ...
        setInterval(function () {
          ...
          $this
            .find(".eut-bg-image")
            .css({
              "background-position": bgPosition + "px center",
    ...
    onePageSettings: function () {
      $('a[href*="#"]:not( [href="#"] )').on("click", function (e) {
        var anchorBarHeight = $(".eut-anchor-menu").length
            ? $(".eut-anchor-menu").outerHeight()
            : 0,
          headerHeight =
            $("#eut-header").data("sticky") != "none"
        ...
        if ($("#eut-responsive-header").is(":visible")) {
          headerHeight =
            $("#eut-header").data("devices-sticky") != "no"
              ? $("#eut-header").data("devices-sticky-height")
              : 0;
        } else {
          if (target.length) {
            headerHeight =
              "advanced" == $("#eut-header").data("sticky") &&
              target.offset().top > $(this).offset().top
                ? 0
                : headerHeight;
          }
        }
        ...
        if (
          target.length &&
          (target.hasClass("eut-section") || target.hasClass("eut-bookmark"))
        ) {
          $("html,body").animate(
            {
              scrollTop:
        ...
        if (
          ...
          var tabLink = $(
            '.eut-tab-link[data-rel="' + targetHash + '"]:visible'
          );
          if (tabLink.length) {
            tabLink.click();
            setTimeout(function () {
    ...
    onePageMenu: function () {
      ...
      var sideHeader = $("#eut-main-header").hasClass("eut-header-side")
          ? true
          : false,
        headerHeight =
          $("#eut-header").attr("data-sticky-header") != "none" && !sideHeader
            ? $("#eut-main-header").outerHeight()
            : 0,
        anchorBarHeight = $(".eut-anchor-menu").length
          ? $(".eut-anchor-menu").outerHeight()
      ...
      $section.each(function () {
        ...
        if (
          sectionOffset <= scroll &&
          sectionOffset + $that.outerHeight() > scroll
        ) {
          $('a[href*="#' + currentId + '"]')
            .parent()
            .addClass("active");
    ...
    fixedFooter: function () {
      ...
      function update() {
        ...
        if (
          windowWidth + scrollBarWidth <= tabletLandscape ||
          footerHeight > windowHeight
        ) {
          $footer
            .removeClass("eut-fixed-footer")
            .prev()
            .css("margin-bottom", "");
        } else {
          $footer
            .addClass("eut-fixed-footer")
            .prev()
    ...
    lightBox: function () {
          ...
          image: {
            ...
            titleSrc: function (item) {
              var title = item.el.data("title") ? item.el.data("title") : "",
                caption = item.el.data("desc")
                  ? "<br><small>" + item.el.data("desc") + "</small>"
                  : "";
              if ("" === title) {
                title = item.el.find(".eut-title").html()
                  ? item.el.find(".eut-title").html()
                  : "";
              }
              if ("" === caption) {
                caption = item.el.find(".eut-caption").html()
                  ? "<br><small>" +
                    item.el.find(".eut-caption").html() +
                    "</small>"
                  : "";
              }
      ...
      if ($(".eut-body").hasClass("eut-privacy-video-embeds-disabled")) {
        $(".eut-youtube-popup, .eut-vimeo-popup, .eut-video-popup").each(
          function () {
  ...
  EUTHEM.basicElements = {
    ...
    autoHeadings: function () {
      var $portfolio = $(
        ".eut-portfolio.eut-auto-headings .eut-isotope-item-inner"
      );
      $portfolio.autoHeading({
        compressor: 20,
        items: [{ item: ".eut-title", min: 18, max: 50 }],
      });
      $(".eut-blog-item.eut-style-2 .eut-blog-item-inner").autoHeading({
        compressor: 10,
        items: [{ item: ".eut-post-title", min: 16, max: 30 }],
      });
    },
    pieChart: function () {
      $(".eut-chart-number").each(function () {
        var $element = $(this),
          delay =
            $element.parent().data("delay") !== ""
              ? parseInt($element.parent().data("delay"))
              : 0,
    ...
    pieChartInit: function ($element, size) {
      var activeColor =
          $element.data("pie-active-color") !== ""
            ? $element.data("pie-active-color")
            : "rgba(0,0,0,1)",
        pieColor =
          $element.data("pie-color") !== ""
            ? $element.data("pie-color")
            : "rgba(0,0,0,0.1)",
        pieLineCap =
          $element.data("pie-line-cap") !== ""
            ? $element.data("pie-line-cap")
            : "round",
        lineSize =
          $element.data("pie-line-size") !== ""
            ? $element.data("pie-line-size")
            : "6",
        chartSize = size;
    ...
    progressBarsInit: function ($element) {
      ...
      if ($element.parent().hasClass("eut-style-1")) {
        percentage
          .appendTo($element.find(".eut-bar"))
          .animate({ left: val + "%" }, 1600);
      } else {
    ...
    counter: function () {
      ...
      $(selector).each(function (i) {
        var elements = $(selector)[i],
          thousandsSeparator =
            $(this).attr("data-thousands-separator") !== ""
              ? $(this).attr("data-thousands-separator")
              : ",";
        $(elements).attr("id", "eut-counter-" + i);
        var delay =
            $(this).parents(".eut-counter").attr("data-delay") !== ""
              ? parseInt($(this).parents(".eut-counter").attr("data-delay"))
              : 200,
          options = {
            useEasing: true,
            useGrouping: true,
            separator:
              $(this).attr("data-thousands-separator-vis") !== "yes"
                ? thousandsSeparator
                : "",
            decimal:
              $(this).attr("data-decimal-separator") !== ""
                ? $(this).attr("data-decimal-separator")
                : ".",
            prefix:
    ...
    slider: function () {
      var $element = $(
        "#eut-main-content .eut-slider-element, #eut-single-media .eut-slider-element"
      );
      ...
      $element.each(function () {
        var $slider = $(this),
          ...
          autoPlay =
            $slider.attr("data-slider-autoplay") != "no" ? true : false,
          autoHeight =
            $slider.attr("data-slider-autoheight") == "yes" ? true : false,
          pagination = $slider.attr("data-pagination") != "no" ? true : false,
          animateOut = false,
          animateIn = false;
        ...
        // Slider Trantition
        if (
          $slider.parents(".eut-slider").hasClass("eut-layout-2") ||
          "fade" == transition
        ) {
    ...
    testimonial: function () {
      ...
      $element.each(function () {
        var $testimonial = $(this),
          sliderSpeed = parseInt($testimonial.attr("data-slider-speed"))
            ? parseInt($testimonial.attr("data-slider-speed"))
            : 3000,
          pagination =
            $testimonial.attr("data-pagination") != "no" ? true : false,
          paginationSpeed = parseInt($testimonial.attr("data-pagination-speed"))
            ? parseInt($testimonial.attr("data-pagination-speed"))
            : 400,
          transition = $testimonial.attr("data-slider-transition"),
          autoHeight =
            $testimonial.attr("data-slider-autoheight") == "yes" ? true : false,
          autoPlay =
            $testimonial.attr("data-slider-autoplay") != "no" ? true : false,
          sliderPause =
            $testimonial.attr("data-slider-pause") == "yes" ? true : false,
          loop = true,
          animateOut = false,
          animateIn = false;
        ...
        // Fixed for Carousel middle content
        if (
          $testimonial.parents(".eut-section").hasClass("eut-middle-content")
        ) {
          var smallDelay;
    ...
    flexibleCarousel: function () {
      ...
      $element.each(function () {
        var $carousel = $(this),
          $nextNav = $carousel
            .parents(".eut-flexible-carousel")
            .find(".eut-carousel-next"),
          $prevNav = $carousel
            .parents(".eut-flexible-carousel")
            .find(".eut-carousel-prev"),
          sliderSpeed = parseInt($carousel.attr("data-slider-speed"))
            ? parseInt($carousel.attr("data-slider-speed"))
            : 3000,
          pagination = $carousel.attr("data-pagination") != "no" ? true : false,
          paginationSpeed = parseInt($carousel.attr("data-pagination-speed"))
          ...
          tabletLandscapeNum = $carousel.attr("data-items-tablet-landscape")
            ? parseInt($carousel.attr("data-items-tablet-landscape"))
            : 4,
          tabletPortraitNum = $carousel.attr("data-items-tablet-portrait")
            ? parseInt($carousel.attr("data-items-tablet-portrait"))
            : 2,
          mobileNum = $carousel.attr("data-items-mobile")
            ? parseInt($carousel.attr("data-items-mobile"))
            : 1,
          gap = $carousel
            .parents(".eut-flexible-carousel")
            .hasClass("eut-with-gap")
            ? 30
            : 0,
          padding =
            $carousel
              .parents(".eut-flexible-carousel")
              .hasClass("eut-with-gap") &&
            $carousel.parents(".eut-section").hasClass("eut-fullwidth")
              ? 30
              : 0;
      ...
      $element.each(function () {
        var $carousel = $(this),
          ...
          mobileNum = $carousel.attr("data-items-mobile")
            ...
            : 1,
          gap =
            $carousel.parents(".eut-carousel").hasClass("eut-with-gap") &&
    ...
    advancedPromo: function () {
      ...
      $item.each(function () {
        ...
        $wrapper.on("click", function () {
          var headerHeight =
              $("#eut-header").data("sticky") != "none"
                ? $("#eut-main-header").outerHeight()
                : 0,
            fieldBarHeight = $(".eut-fields-bar").length
              ? $(".eut-fields-bar").outerHeight()
              : 0,
            offset = $(this).offset().top,
        ...
        $wrapper.mouseenter(function () {
          $(this).css({
            "padding-top": paddingTop + 40,
            "padding-bottom": paddingBottom + 40,
          });
        });
        ...
        if ($(".eut-product-image.easyzoom").length) {
          ...
          $(".variations_form").on(
            ...
            function (event, variation) {
              var imageZoom = $(
                ".eut-product-image .woocommerce-main-image"
              ).attr("href");
              var $productImg = $(
                ".eut-product-image .woocommerce-main-image img"
              );
    ...
    animAppear: function () {
      if (
        bodyLoader ||
        $("body").hasClass("page-template-template-full-page")
      ) {
        return;
      }
    ...
    accordionToggle: function () {
      $(".eut-accordion-wrapper.eut-action-toggle li .eut-title-wrapper").on(
        "click",
        function () {
          var $that = $(this);
          ...
          if (
            $(this).parent().find(".eut-blog-leader.eut-fildisi-style").length
          ) {
            EUTHEM.leaderPostSize.init();
          }
        }
      );
      $(".eut-accordion-wrapper.eut-action-accordion li .eut-title-wrapper").on(
        "click",
        function () {
          var $that = $(this);
          $that
      ...
      $(".eut-tab-title").on("click", function () {
        ...
        if (
          $that
            .parents(".eut-tab")
            .find(".eut-tab-content")
            .find(".eut-blog-leader.eut-fildisi-style").length
        ) {
          EUTHEM.leaderPostSize.init();
        }
      });
    ...
    hovers: function () {
      ...
      if (
        isMobile.any() &&
        0 == fildisi_eutf_main_data.device_hover_single_tap
      ) {
  ...
  EUTHEM.isotope = {
    ...
    settings: function ($element) {
      var $container = $element.find(".eut-isotope-container"),
        ...
        columnWidth = $element.hasClass("eut-portfolio")
          ? ".eut-image-square"
          : "",
        dataSpinner = $element.data("spinner"),
        gap =
          $element.hasClass("eut-with-gap") &&
          !isNaN($element.data("gutter-size"))
            ? Math.abs($element.data("gutter-size")) / 2
            : 0,
        isOriginLeft = $("body").hasClass("rtl") ? false : true;

      var offset = $element.parents(".eut-section").hasClass("eut-fullwidth")
          ? -(gap * 2)
          : gap * 2,
      ...
      if (
        $element.hasClass("eut-with-gap") &&
        $element.parents(".eut-section").hasClass("eut-fullwidth")
      ) {
        ...
        if (!resizing) {
          ...
          if (initIso) {
            ...
            smallDelay = window.setTimeout(function () {
              ...
              if (
                $container.parents(".eut-section").hasClass("eut-custom-height")
              ) {
                $container
                  .parents(".eut-section")
                  .data("plugin_columnSize")
      ...
      function setColumns() {
        ...
        $element.removeClass(
          "eut-isotope-column-5 eut-isotope-column-4 eut-isotope-column-3 eut-isotope-column-2 eut-isotope-column-1"
        );
      ...
      function itemSize() {
        ...
        if (columns != 1) {
          $container
            .find(".eut-image-landscape")
            .css({ width: columnW * 2 })
            .find(".eut-media")
            .css({ height: columnW - gap * 2 });
          $container
            .find(".eut-image-portrait")
            .css({ width: columnW })
            .find(".eut-media")
      ...
      function gridEqualColumns() {
        ...
        // Reset Height
        $container
          .find(".eut-isotope-item .eut-post-content")
          .css("height", "auto");
        $container
          .find(".eut-isotope-item .eut-blog-item-inner")
          .css("height", "auto");
        $container
          .find(".eut-isotope-item .eut-post-meta-wrapper")
          .removeClass("eut-bottom");
  ...
  EUTHEM.fullPage = {
    init: function () {
      ...
      var deviceFullPageEnable =
        $fPage.data("device-scrolling") == "yes" ? true : false;
      ...
      $fPage.fullpage({
        ...
        afterLoad: function (anchorLink, index) {
          var sectionHeaderColor = $($section[index - 1]).attr(
            "data-header-color"
          );
  ...
  EUTHEM.sectionNav = {
    init: function () {
      ...
      function createList() {
        $(
          '<div id="eut-section-nav"><div class="eut-inner-nav"></div></div>'
        ).appendTo($themeWrapper);
        $section.each(function () {
          var $that = $(this);
          var title = $that.data("anchor-tooltip");
          anchor = $that.data("anchor");
          var $listEl = $(
            '<a class="eut-nav-item eut-small-text" href="' +
              anchor +
              '">' +
              title +
              "</a>"
      ...
      function updateNav() {
        $section.each(function () {
          var $that = $(this);
          if (
            $that.offset().top - $(window).height() / 2 <
              $(window).scrollTop() &&
            $that.offset().top + $that.outerHeight() - $(window).height() / 2 >
              $(window).scrollTop()
          ) {
            $navigation
              .find("a[href=" + $that.data("anchor") + "]")
              .addClass("active");
          } else {
            $navigation
              .find("a[href=" + $that.data("anchor") + "]")
